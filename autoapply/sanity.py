...
SYSTEM = (
    ...
    "You are NOT shown the options any question offers. Never say an answer is "
    "not among the offered options, is unsupported by them, or does not appear "
    "in a dropdown -- you cannot see them, and a form that accepted the answer "
    "is better evidence than a guess about a list you were not given.\n"
